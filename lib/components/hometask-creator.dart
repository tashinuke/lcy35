...
class HometaskCreatorState extends State<HometaskCreator> {
  ...
  Widget build(BuildContext context) {
    ...
    selectedSubject = (timetable.contains(selectedSubject) ? selectedSubject : null) ?? timetable[0];
    return Scaffold(
        ...
        appBar: AppBar(
            ...
            elevation: 0,
            title: Container(
              child: Text('Создать работу', style: TitleTS),
            )),
        body: Center(
            child: Column(
          children: [
